...
export declare enum HandoverStatus {
    NORMAL = "normal",
...
export declare enum HandoverProcessStatus {
    GRACE_PERIOD = "grace_period",
...
export declare enum SystemStatusType {
...
//# sourceMappingURL=dead-mans-switch.d.ts.map